...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图度版块';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户快捷板块表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户常用版块记录表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户板块排序表';
...
CREATE TABLE `td_contact_group` (
  ...
  KEY `idx_order_num` (`order_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='联系人群组';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='任务周期';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图度主题表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图度组关系表';
...
CREATE TABLE `td_tudu_meeting` (
  ...
  PRIMARY KEY (`tudu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会议信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图度用户表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图度标签表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工作流内容附件关联表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='常用工作流';
...
CREATE TABLE `td_rule` (
  ...
  PRIMARY KEY (`rule_id`),
  KEY `idx_unique_id` (`unique_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图度规则';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图度规则过滤条件';
...
CREATE TABLE `nd_folder` (
  ...
  KEY `idx_is_system` (`is_system`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网盘目录';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='共享文件关系表';
...
CREATE TABLE `td_tudu_flow` (
  ...
  `tudu_id` varchar(36) NOT NULL COMMENT '图度ID',
  `flow_id` varchar(36) NOT NULL COMMENT '工作流模版ID',
  `steps` text CHARACTER SET utf8 NOT NULL COMMENT '步骤数据 xml格式',
  `step_num` int(11) NOT NULL DEFAULT '0' COMMENT '步骤数',
  `current_step_id` varchar(36) NOT NULL COMMENT '当前步骤标识',
  PRIMARY KEY (`tudu_id`),
  KEY `org_id` (`org_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='共享文件关系表';
