...
CREATE TABLE `md_user_device` (
  `org_id` varchar(60) NOT NULL COMMENT '组织ID',
  `unique_id` varchar(36) NOT NULL COMMENT '用户ID',
  `device_type` varchar(16) NOT NULL COMMENT '设备类型',
  `device_token` varchar(128) NOT NULL COMMENT '设备码',
...
CREATE TABLE `md_auth_client` (
  ...
  `client_name` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '客户端名称',
